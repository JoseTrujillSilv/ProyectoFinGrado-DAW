...
$keyssEncrypt = crypt($keyssString, '27776361HHg@###ir..');
...
$sql = $bbdd->prepare("INSERT INTO comunidades VALUES(?,?,?,?,?)");

$sql->bind_param('issss', $id, $name, $passwordEncrypt, $formatImage, $keyssEncrypt);
